...
import { IBoxModelType, ILocalizationType, IHoverStyleType, IClickStyleType, IAxisType, IReferenceStyleType, IDataLabelType, ITooltipLabelType, IAccessibilityType, IAnimationConfig, ILegendType, ISeriesLabelType, ISecondaryLinesType, ISubTitleType } from '@visa/charts-types';
...
export declare class LineChart {
    ...
    lineCurveWatcher(_newLineCurve: any, _oldLineCurve: any): void;
