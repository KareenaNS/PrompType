...
import { IBoxModelType, ILocalizationType, IHoverStyleType, IClickStyleType, IAxisType, IReferenceStyleType, IDataLabelType, ITooltipLabelType, IAccessibilityType, IAnimationConfig, ILegendType, ISubTitleType } from '@visa/charts-types';
export declare class StackedBarChart {
    ...
    shouldValidateAxes: boolean;
    shouldValidateClickHighlight: boolean;
    ...
    shouldUpdateTotalLabels: boolean;
    ...
    normalizedWatcher(_newVal: any, _oldVal: any): void;
    ...
    showTotalValueWatcher(_newVal: any, _oldVal: any): void;
    ...
    showZeroLabelsWatcher(_newVal: any, _oldVal: any): void;
    ...
    processLabelOpacity(selection: any, addCollisionClass?: any): void;
    ...
    exitDataLabels(): void;
    drawDataLabels(): void;
    enterTotalDataLabels(): void;
    updateTotalDataLabels(): void;
    exitTotalDataLabels(): void;
    drawTotalDataLabels(): void;
