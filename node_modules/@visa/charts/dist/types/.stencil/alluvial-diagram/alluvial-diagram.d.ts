...
import { IBoxModelType, ILocalizationType, IHoverStyleType, IClickStyleType, IDataLabelType, ITooltipLabelType, IAccessibilityType, IAnimationConfig, INodeConfigType, ILinkConfigType, ISubTitleType } from '@visa/charts-types';
...
export declare class AlluvialDiagram {
    ...
    newColumnInterpolationPositionVertical(): any;
