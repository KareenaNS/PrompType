...
export declare class BarChart {
    ...
    shouldSetLabelPosition: boolean;
    shouldSetLabelContent: boolean;
    ...
    referenceLinesWatcher(_newVal: any, _oldVal: any): void;
    ...
    shouldCenterBaseline(): boolean;
    prepareScales(): void;
    reSetRoot(): void;
    checkHideAxisState(axisName: string, relevantLayout: string, minValue: number): boolean;
    drawXAxis(): void;
    drawYAxis(): void;
    drawBaseline(): void;
    ...
    processLabelPosition(selection: any, runTransition?: any, redrawBitmap?: any, suppressMarkDraw?: any): void;
