...
export class ScatterPlot {
    constructor() {
            ...
            const baseColor = clicked
                ...
                : hovered
                    ...
                    : this.groupAccessor && this.sizeConfig.dualEncodeColor
                        ? scaleSequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], interpolate('#fff', this.dotColor(d[this.groupAccessor])))(d[this.sizeConfig.sizeAccessor]) || this.dotColor(d[this.groupAccessor])
                        : this.groupAccessor && this.sizeConfig && !this.sizeConfig.dualEncodeColor
                            ? this.dotColor(d[this.groupAccessor])
                            : !this.groupAccessor && this.sizeConfig.dualEncodeColor
                                ? scaleSequentialSqrt([Math.max(0, this.sizeMin), this.sizeMax], interpolate('#fff', this.rawColors[0]))(d[this.sizeConfig.sizeAccessor]) || this.rawColors[0]
                                : this.rawColors[0];
            if (!this.accessibility.hideStrokes) {
        ...
        this.localization = ScatterPlotDefaultValues.localization;
        ...
        this.xMaxValueOverride = undefined;
        this.xMinValueOverride = undefined;
        this.yMaxValueOverride = undefined;
        this.yMinValueOverride = undefined;
    ...
    innerScopeDataKeys() {
        ...
        const innerChartAccessors = Object.assign(Object.assign({}, chartAccessors), { singleAccessors: innerChartSingleAccessors });
    ...
    drawLegendElements() {
        ...
        const noGroupAccessor = this.groupAccessor === ScatterPlotDefaultValues.groupAccessor &&
            this.nest &&
            this.nest.length === 1 &&
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (h("div", { key: 'a76a5ed99aaab7d1a1f27aa10cee44f8fe7652e5', class: "o-layout" }, h("div", { key: 'ebf3bdfceeb58a916fcc2b10ad08ab27f2f3370d', class: "o-layout--chart" }, h(this.topLevel, { key: '11bb95a9ea035d9a7b740deba9aeacb94adff716', class: "scatter-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { key: 'b71dc286891fcb79746ce98839a0a08a83b12771', class: "visa-ui-text--instructions scatter-sub-title vcl-sub-title" }), h("div", { key: 'c2012b947125f56ed2e38bfea3baf16c2b34bd4f', class: "scatter-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { key: '2e3dd46c20619c6e17fcfbfc81b9693572bbc95d', uniqueID: this.chartID, geomType: 'point', groupName: 'scatter group', language: this.getLanguageString(), chartTag: 'scatter-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), h("div", { key: 'da06db013823f5e0f98bac5549b0a795b99bcd04', class: "visa-viz-d3-scatter-container" }), h("div", { key: 'daf70506d1c6b612361fa459505d5e5b9e284b05', class: "scatter-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { key: '376b0db12184db8f3061547c53e846d65b6a37b4', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, data: this.tableData, dataKeyNames: this.dataKeyNames, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
    ...
    static get properties() {
        return {
            "localization": {
                ...
                "defaultValue": "ScatterPlotDefaultValues.localization"
            },
            "mainTitle": {
                "type": "string",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.mainTitle"
            },
            "subTitle": {
                "type": "string",
                "mutable": true,
                ...
                "attribute": "sub-title",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.subTitle"
            },
            "height": {
                "type": "number",
                "mutable": true,
                ...
                "attribute": "height",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.height"
            },
            "width": {
                "type": "number",
                "mutable": true,
                ...
                "attribute": "width",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.width"
            },
            "margin": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.margin"
            },
            "padding": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.padding"
            },
            "highestHeadingLevel": {
                "type": "any",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.highestHeadingLevel"
            },
            "data": {
                "type": "unknown",
                "mutable": false,
            ...
            "xAccessor": {
                ...
                "attribute": "x-accessor",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.xAccessor"
            },
            "yAccessor": {
                "type": "string",
                "mutable": true,
                ...
                "attribute": "y-accessor",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.yAccessor"
            },
            "sizeConfig": {
                "type": "any",
                "mutable": true,
                ...
                "attribute": "size-config",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.sizeConfig"
            },
            "groupAccessor": {
                "type": "string",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.groupAccessor"
            },
            "xAxis": {
                "type": "unknown",
                "mutable": true,
                "complexType": {
                    ...
                    "references": {
                        "IAxisType": {
                            "location": "import",
                            "path": "@visa/charts-types",
                            "id": "../types/dist/index.d.ts::IAxisType"
                        }
                    }
                },
                "required": false,
                ...
                "defaultValue": "ScatterPlotDefaultValues.xAxis"
            },
            "yAxis": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.yAxis"
            },
            "showBaselineX": {
                "type": "boolean",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.showBaselineX"
            },
            "showBaselineY": {
                "type": "boolean",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.showBaselineY"
            },
            "colorPalette": {
                "type": "string",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.colorPalette"
            },
            "colors": {
                "type": "unknown",
                "mutable": true,
            ...
            "dotRadius": {
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.dotRadius"
            },
            "dotOpacity": {
                "type": "number",
                "mutable": true,
                ...
                "attribute": "dot-opacity",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.dotOpacity"
            },
            "hoverStyle": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.hoverStyle"
            },
            "clickStyle": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.clickStyle"
            },
            "referenceStyle": {
                "type": "unknown",
                "mutable": true,
                "complexType": {
                    ...
                    "references": {
                        "IReferenceStyleType": {
                            "location": "import",
                            "path": "@visa/charts-types",
                            "id": "../types/dist/index.d.ts::IReferenceStyleType"
                        }
                    }
                },
                "required": false,
                ...
                "defaultValue": "ScatterPlotDefaultValues.referenceStyle"
            },
            "cursor": {
                "type": "string",
                "mutable": true,
                ...
                "attribute": "cursor",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.cursor"
            },
            "hoverOpacity": {
                "type": "number",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.hoverOpacity"
            },
            "animationConfig": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.animationConfig"
            },
            "fitLineStyle": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.fitLineStyle"
            },
            "dotSymbols": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.dotSymbols"
            },
            "dataLabel": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.dataLabel"
            },
            "dataKeyNames": {
                "type": "unknown",
                "mutable": true,
            ...
            "showTooltip": {
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.showTooltip"
            },
            "tooltipLabel": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.tooltipLabel"
            },
            "accessibility": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.accessibility"
            },
            "legend": {
                "type": "unknown",
                "mutable": true,
                "complexType": {
                    ...
                    "references": {
                        "ILegendType": {
                            "location": "import",
                            "path": "@visa/charts-types",
                            "id": "../types/dist/index.d.ts::ILegendType"
                        }
                    }
                },
                "required": false,
                ...
                "defaultValue": "ScatterPlotDefaultValues.legend"
            },
            "annotations": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.annotations"
            },
            "xMaxValueOverride": {
                "type": "number",
                "mutable": false,
                ...
                "attribute": "x-max-value-override",
                "reflect": false
            },
            "xMinValueOverride": {
                "type": "number",
                ...
                "attribute": "x-min-value-override",
                "reflect": false
            },
            "yMaxValueOverride": {
                "type": "number",
                ...
                "attribute": "y-max-value-override",
                "reflect": false
            },
            "yMinValueOverride": {
                "type": "number",
                ...
                "attribute": "y-min-value-override",
                "reflect": false
            },
            "showFitLine": {
                "type": "boolean",
                ...
                "attribute": "show-fit-line",
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.showFitLine"
            },
            "referenceLines": {
                "type": "unknown",
                "mutable": true,
                ...
                "defaultValue": "ScatterPlotDefaultValues.referenceLines"
            },
            "suppressEvents": {
                "type": "boolean",
                "mutable": true,
                ...
                "reflect": false,
                "defaultValue": "ScatterPlotDefaultValues.suppressEvents"
            },
            "hoverHighlight": {
                "type": "unknown",
                "mutable": true,
            ...
            "clickHighlight": {
                ...
                "defaultValue": "ScatterPlotDefaultValues.clickHighlight"
            },
            "interactionKeys": {
                "type": "unknown",
                "mutable": true,
    ...
    static get elementRef() { return "scatterChartEl"; }
    static get watchers() {
        return [{
                "propName": "data",
                ...
                "propName": "xAccessor",
                "methodName": "xAccessorWatcher"
            }, {
                "propName": "yAccessor",
                "methodName": "yAccessorWatcher"
            }, {
                "propName": "sizeConfig",
                "methodName": "sizeConfigWatcher"
            }, {
                ...
                "propName": "dotOpacity",
                "methodName": "dotOpacityWatcher"
            }, {
                "propName": "dotSymbols",
                "methodName": "dotSymbolsWatcher"
            }, {
                "propName": "hoverStyle",
                ...
                "propName": "fitLineStyle",
                "methodName": "fitLineStyleWatcher"
            }, {
                "propName": "cursor",
                ...
                "propName": "xMaxValueOverride",
                "methodName": "xValueOverrideWatcher"
            }, {
                "propName": "xMinValueOverride",
                "methodName": "xValueOverrideWatcher"
            }, {
                "propName": "yMaxValueOverride",
                "methodName": "yValueOverrideWatcher"
            }, {
                "propName": "yMinValueOverride",
                "methodName": "yValueOverrideWatcher"
            }, {
                "propName": "showFitLine",
                "methodName": "showFitLineWatcher"
            }, {
