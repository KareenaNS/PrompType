...
const index$1 = require('./index-db5ecd0d.js');
const visaChartsUtils_umd = require('./visa-charts-utils.umd-982324c5.js');
const index$2 = require('./index-ee6239ca.js');
...
CirclePackingDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
CirclePackingDefaultValues.localization = propDefaultValues.localization;
...
const CirclePacking = class {
    constructor(hostRef) {
        ...
        this.initialLoadEndEvent = index$1.createEvent(this, "initialLoadEndEvent", 7);
    ...
    renderRootElements() {
        ...
        this.subTitleG = visaChartsUtils_umd.select(this.circlePackingEl).select('.circle-packing-sub-title');
    ...
    render() {
        ...
        return (index$1.h("div", { key: '79ec0386c06e1e0c360cef9d80eafe35b5b69a52', class: "o-layout", "data-testid": "outer-layout" }, index$1.h("div", { key: '7866aa053778a794af1ca4d387ec727e42f6da62', class: "o-layout--chart", "data-testid": "layout-chart" }, index$1.h(this.topLevel, { key: '638cea8cdfcd360aa6fdb50791f169cba9a3902b', "data-testid": "main-title" }, this.mainTitle), index$1.h(this.bottomLevel, { key: 'bd19899287b8cf655b1537874f22f7a46f7a320b', class: "visa-ui-text--instructions circle-packing-sub-title vcl-sub-title", "data-testid": "sub-title" }), index$1.h("keyboard-instructions", { key: '3734584d4822584f3dd046d2dd75aebba16d17e6', uniqueID: this.chartID, geomType: 'node', groupName: 'node collection', language: this.getLanguageString(), chartTag: 'circle-packing', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index$1.h("div", { key: 'c8c32a11274566ca897d7e1c312af6fab62106d4', class: "visa-viz-circle-packing-container", "data-testid": "chart-container" }), index$1.h("div", { key: '39aa91db80095f8ad5f9ae70c2a05bf74ff7da88', class: "circle-packing-tooltip vcl-tooltip", "data-testid": "tooltip-container", style: { display: this.showTooltip ? 'block' : 'none' } }), index$1.h("data-table", { key: 'baa297fb4e9e490753f7e952642a663950db210b', uniqueID: this.chartID, language: this.getLanguageString(), unitTest: true, isCompact: true, tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton }))));
    }
    init() {
        // reading properties
...
CirclePacking.style = CirclePackingStyle0;

exports.circle_packing = CirclePacking;

//# sourceMappingURL=circle-packing.cjs.entry.js.map