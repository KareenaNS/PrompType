...
const bump = require('./bump-37d6eb5a.js');
const point = require('./point-6f728d20.js');
...
function link(curve) {
  ...
  link.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : array.constant(+_), link) : x;
  };

  link.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : array.constant(+_), link) : y;
  };
...
AlluvialDiagramDefaultValues.subTitle = propDefaultValues.subTitle.text;
AlluvialDiagramDefaultValues.height = 300;
AlluvialDiagramDefaultValues.width = 650;
AlluvialDiagramDefaultValues.layout = propDefaultValues.layoutHorizontal;
...
AlluvialDiagramDefaultValues.localization = propDefaultValues.localization;
...
const AlluvialDiagram = class {
    constructor(hostRef) {
        ...
        this.layout = AlluvialDiagramDefaultValues.layout;
        this.linkData = undefined;
        this.nodeData = undefined;
        this.uniqueID = undefined;
        this.localization = AlluvialDiagramDefaultValues.localization;
    ...
    layoutWatcher(_newVal, _oldVal) {
        ...
        this.shouldDrawNodeLabels = true;
        this.shouldUpdateAnnotations = true;
        console.warn('Change detected in prop layout from value ' +
            _oldVal +
            ' to value ' +
            _newVal +
    ...
    renderRootElements() {
        ...
        this.subTitleG = visaChartsUtils_umd.select(this.alluvialDiagramEl).select('.alluvial-sub-title');
    ...
    placeNodeLabels({ root, layout, dataLabel, innerPaddedWidth }) {
    ...
    drawNodeLabels() {
        ...
        const nodeLabelUpdate = this.updatingLabels
            ...
            .attr('data-x', d => this.layout === 'vertical'
            ? d.x0 + (d.x1 - d.x0) / 2
            : this.dataLabel.placement === 'outside'
                ...
                : d.x0 < this.innerPaddedWidth / 2
                    ? d.x1 + cloneAdjustment
                    : d.x0 - cloneAdjustment) // note we hacked vertical layout so still have to use width here
            .attr('data-y', d => this.layout === 'vertical'
            ? this.dataLabel.placement === 'outside'
            ...
            const nodeRects = this.updateNodes
                ...
                if (!hideOnly) {
                    ...
                    visaChartsUtils_umd.select(sourceCopy)
                        ...
                        .attr('tabindex', null)
                        .attr('data-x', this.layout === 'vertical'
                        ? d.x0
                        : collisionPlacement === 'all'
                            ...
                            : collisionPlacement === 'outside'
                                ...
                                : d.x0 < this.innerPaddedWidth / 2
                                    ? d.x1 + cloneAdjustment
                                    : d.x0 - cloneAdjustment) // note we hacked vertical layout so still have to use width here
                        .attr('data-y', this.layout === 'vertical'
                        ? collisionPlacement === 'all'
                            ? d.y0
                            : collisionPlacement === 'outside'
                                ? d.y0 < this.innerPaddedWidth / 2
                                ...
                                : d.y0 < this.innerPaddedWidth / 2
                                    ...
                                    : d.y0 - cloneAdjustment
                        : d.y0)
                        .attr('data-width', this.layout === 'vertical' ? d.x1 - d.x0 : collisionPlacement === 'all' ? d.x1 - d.x0 : 1)
                        .attr('data-height', this.layout === 'vertical' ? (collisionPlacement === 'all' ? d.y1 - d.y0 : 1) : d.y1 - d.y0);
    ...
    render() {
        ...
        index.h("div", { key: '239c56c8813ca9ffefb27d79889feb960f65ff68' }, index.h("div", { key: 'bfab71f0780570d3bee705f2d1b093d5a875fc66', class: "o-layout" }, index.h("div", { key: 'cb27635d243133f9b1317267d99bce5e27e0f602', class: "o-layout--chart" }, index.h(this.topLevel, { key: 'fa079bd089cf7c9301e92e4c4d7f76a6c366a80a', class: "alluvial-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: '47a02cb194c81d3af40fc4bd96b331bef78e94bb', class: "visa-ui-text--instructions alluvial-sub-title vcl-sub-title" }), index.h("keyboard-instructions", { key: '4e1228172a9f711a998893030dadd178c6147aa0', uniqueID: this.chartID, geomType: 'node', groupName: 'node collection', language: this.getLanguageString(), chartTag: 'alluvial-diagram', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: this.innerLinkFillMode === 'source' || this.innerLinkFillMode === 'target', disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: 'd7c323ed2c41ca0084e4bde0a6c6236265962d2e', class: "visa-viz-d3-alluvial-container" }), index.h("div", { key: '2646ae41d976cc731b21018bfa04eaf7d3ae9f36', class: "alluvial-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '3b94a8ba0b713d508aeed3c208a15b29f3b2c39e', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, secondaryData: this.secondaryTableData, secondaryTableColumns: this.secondaryTableColumns, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest })))));
    }
    init() {
        // reading properties
...
AlluvialDiagram.style = AlluvialDiagramStyle0;

exports.alluvial_diagram = AlluvialDiagram;

//# sourceMappingURL=alluvial-diagram.cjs.entry.js.map