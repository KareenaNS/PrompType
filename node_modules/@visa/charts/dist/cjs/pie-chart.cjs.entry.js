...
const array = require('./array-af0deba8.js');
const math = require('./math-508938d6.js');
const circle = require('./circle-c05489f3.js');
const value = require('./value-95dc4e8f.js');
...
function arc() {
  var innerRadius = arcInnerRadius,
      ...
      cornerRadius = array.constant(0),
      padRadius = null,
      startAngle = arcStartAngle,
      endAngle = arcEndAngle,
      padAngle = arcPadAngle,
      context = null,
      path = array.withPath(arc);
  ...
  function arc() {
    ...
    // Is it a point?
    if (!(r1 > math.epsilon)) context.moveTo(0, 0);
    ...
    // Or is it a circular or annular sector?
      ...
      var a01 = a0,
          ...
          rp = (ap > math.epsilon) && (padRadius ? +padRadius.apply(this, arguments) : math.sqrt(r0 * r0 + r1 * r1)),
      ...
      if (rp > math.epsilon) {
        ...
        if ((da0 -= p0 * 2) > math.epsilon) p0 *= (cw ? 1 : -1), a00 += p0, a10 -= p0;
        else da0 = 0, a00 = a10 = (a0 + a1) / 2;
        if ((da1 -= p1 * 2) > math.epsilon) p1 *= (cw ? 1 : -1), a01 += p1, a11 -= p1;
      ...
      if (!(da1 > math.epsilon)) context.moveTo(x01, y01);
      ...
      if (!(r0 > math.epsilon) || !(da0 > math.epsilon)) context.lineTo(x10, y10);
  ...
  arc.innerRadius = function(_) {
    return arguments.length ? (innerRadius = typeof _ === "function" ? _ : array.constant(+_), arc) : innerRadius;
  };

  arc.outerRadius = function(_) {
    return arguments.length ? (outerRadius = typeof _ === "function" ? _ : array.constant(+_), arc) : outerRadius;
  };

  arc.cornerRadius = function(_) {
    return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : array.constant(+_), arc) : cornerRadius;
  };

  arc.padRadius = function(_) {
    return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : array.constant(+_), arc) : padRadius;
  };

  arc.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : array.constant(+_), arc) : startAngle;
  };

  arc.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : array.constant(+_), arc) : endAngle;
  };

  arc.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : array.constant(+_), arc) : padAngle;
  };
...
function pie() {
  var value = identity,
      ...
      sort = null,
      startAngle = array.constant(0),
      endAngle = array.constant(math.tau),
      padAngle = array.constant(0);
  ...
  pie.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : array.constant(+_), pie) : value;
  };
  ...
  pie.startAngle = function(_) {
    return arguments.length ? (startAngle = typeof _ === "function" ? _ : array.constant(+_), pie) : startAngle;
  };

  pie.endAngle = function(_) {
    return arguments.length ? (endAngle = typeof _ === "function" ? _ : array.constant(+_), pie) : endAngle;
  };

  pie.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : array.constant(+_), pie) : padAngle;
  };
...
PieChartDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
PieChartDefaultValues.localization = propDefaultValues.localization;
...
const PieChart = class {
    constructor(hostRef) {
        ...
        this.localization = PieChartDefaultValues.localization;
    ...
    setTableData() {
        ...
        if (this.showPercentage) {
            const label = this.dataKeyNames && (this.dataKeyNames[`${this.valueAccessor}`] || this.dataKeyNames[`${this.valueAccessor}%`])
    ...
    renderRootElements() {
        ...
        this.subTitleG = visaChartsUtils_umd.select(this.pieChartEl).select('.pie-sub-title');
    ...
    drawDataLabels(group) {
        ...
        this['updating' + group]
            ...
            if (this.dataLabel.visible && this.dataLabel.collisionHideOnly) {
                ...
                this.bitmaps = resolveLabelCollision({
                    bitmaps: this.bitmaps,
                    labelSelection: visaChartsUtils_umd.select(me), // highlightLabels,
                    avoidMarks: [],
                    validPositions,
                    offsets,
                    accessors: [this.ordinalAccessor],
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: 'fcc4118dfc21a7684f617e29283e58bab9fa9cf6', class: "o-layout is--vertical" }, index.h("div", { key: 'a0c58f57073887350712e27b38fb1387f3a9477d', class: "o-layout--chart" }, index.h(this.topLevel, { key: '229ea92633c6f866a7d56352f3fba8ee8821022c', class: "pie-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: '341897471fd98e1b98f1d8060ab2f6132d529cce', class: "visa-ui-text--instructions pie-sub-title vcl-sub-title" }), index.h("keyboard-instructions", { key: 'ea26f4c106b308fafbec8edda4da13ba536d9f62', uniqueID: this.chartID, geomType: 'slice', groupName: 'pie', language: this.getLanguageString(), chartTag: 'pie-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: false, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: '75adca88ca2554f58fe644756251568c8eb4fa7a', class: "visa-viz-d3-pie-container" }), index.h("div", { key: '688600464cbf44a91ccde24c545f0f59cd25f1f0', class: "pie-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '924be95af58ad22bee5275aeeda295bd341b22ee', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
