...
const BarChart = class {
    ...
    prepareLabelData() {
        if (this.preppedData) {
            // min
            const minIdx = minIndex.minIndex(this.preppedData, d => d[this.valueAccessor]);
            const minItem = this.preppedData[minIdx];
            // max
            const maxIdx = minIndex.maxIndex(this.preppedData, d => d[this.valueAccessor]);
    ...
    shouldCenterBaseline() {
        return (((this.xAxis.centerBaseline && this.layout === 'horizontal') ||
            ...
            min.min(this.preppedData, d => d[this.valueAccessor]) >= 0);
    }
    prepareScales() {
        ...
        const minBarValue = this.shouldCenterBaseline()
            ? this.maxValueOverride && this.maxValueOverride > max.max(this.preppedData, d => d[this.valueAccessor])
                ? -halve(this.maxValueOverride)
                : -halve(max.max(this.preppedData, d => d[this.valueAccessor]))
            : this.minValueOverride && this.minValueOverride < min.min(this.preppedData, d => d[this.valueAccessor])
    ...
    drawXAxis() {
        ...
        drawAxis({
            ...
            hide: this.checkHideAxisState('xAxis', 'horizontal', min.min(this.preppedData, d => d[this.valueAccessor])),
            duration: this.duration
        });
    }
    drawYAxis() {
        ...
        drawAxis({
            ...
            padding: this.padding,
            hide: this.checkHideAxisState('yAxis', 'vertical', min.min(this.preppedData, d => d[this.valueAccessor])),
            duration: this.duration
        });
    }
    drawBaseline() {
    ...
    setXAxisAccessibility() {
        ...
        setAccessXAxis({
            ...
            hasXAxis: !this.checkHideAxisState('xAxis', 'horizontal', min.min(this.preppedData, d => d[this.valueAccessor])), // this is inverse of how drawAxis works
    ...
    setYAxisAccessibility() {
        ...
        setAccessYAxis({
            rootEle: this.barChartEl,
            hasYAxis: !this.checkHideAxisState('yAxis', 'vertical', min.min(this.preppedData, d => d[this.valueAccessor])), // this is inverse of how drawAxis works
    ...
    renderRootElements() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.barChartEl)
            .select('.bar-legend')
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.barChartEl).select('.bar-sub-title');
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: 'de2d609e8ad6e8bf4e51f0f52524e6c5489d15f0', class: `o-layout is--${this.layout} ${theme}` }, index.h("div", { key: 'dcab0711587a54310f495c7873510b40ca196c8b', class: "o-layout--chart" }, index.h(this.topLevel, { key: 'f5ecd8b179b12b632d843e1aef32afa3d9f0607f', class: "bar-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: 'fa7f44f807bd7d85aeb5b9460ffbe51df1fd73ef', class: "visa-ui-text--instructions bar-sub-title vcl-sub-title" }), index.h("div", { key: '7e55b27bcfa21ff480950a2b6fefdcee09abcd5a', class: "bar-legend vcl-legend", style: { display: this.legend.visible && this.groupAccessor ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: '96dedc7e08082c39fa020a0a9d002d95a12c75c1', uniqueID: this.chartID, geomType: 'bar', groupName: 'bar group', language: this.getLanguageString(), chartTag: 'bar-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: this.groupAccessor ? true : false, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: '5473c0e6120afa63f1fee1dafb860a34f40d13b0', class: "visa-viz-d3-bar-container" }), index.h("div", { key: '7d040b3660e9aca026e88b502e992d84fb4fb7b7', class: "bar-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: 'ebf206024a2038c17cf483f2302e3f852ed9f66e', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
        // reading properties
...
//# sourceMappingURL=bar-chart.cjs.entry.js.map