...
const band = require('./band-5444a382.js');
const linear = require('./linear-fae91d4d.js');
const time = require('./time-e46af440.js');
const visaChartsUtils_umd = require('./visa-charts-utils.umd-982324c5.js');
const index$1 = require('./index-ee6239ca.js');
const year = require('./year-703ecd65.js');
const catmullRom = require('./catmullRom-9748bd6b.js');
const min = require('./min-53630828.js');
const max = require('./max-67898fc1.js');
const minIndex = require('./minIndex-1504cbe5.js');
const circle = require('./circle-c05489f3.js');
require('./range-f39c731a.js');
require('./value-95dc4e8f.js');
require('./array-af0deba8.js');
require('./point-6f728d20.js');
require('./math-508938d6.js');
 ...
 *
 **/
const { propDefaultValues } = visaChartsUtils_umd.Utils;
...
LineChartDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
LineChartDefaultValues.localization = propDefaultValues.localization;
...
LineChartDefaultValues.lineCurve = propDefaultValues.lineCurve;
...
const LineChartStyle0 = lineChartCss;
...
const LineChart = class {
    constructor(hostRef) {
        ...
        this.initialLoadEndEvent = index.createEvent(this, "initialLoadEndEvent", 7);
        ...
        this.updated = true;
        this.time = {
            timemillisecond: time.timeMillisecond,
            timesecond: time.timeSecond,
            timeminute: time.timeMinute,
            timehour: year.timeHour,
            timeday: year.timeDay,
            timeweek: year.sunday,
            timemonth: year.timeMonth,
            timeyear: year.timeYear
        };
        this.curveOptions = {
            linear: catmullRom.curveLinear,
            step: curveStep,
            catmullRom: catmullRom.curveCatmullRom
        };
        ...
        this.localization = LineChartDefaultValues.localization;
        ...
        this.lineCurve = LineChartDefaultValues.lineCurve;
    ...
    lineCurveWatcher(_newLineCurve, _oldLineCurve) {
        ...
        this.shouldUpdateBaseline = true;
        this.shouldUpdateAnnotations = true;
        console.warn('Change detected in prop lineCurve from value ' +
            _newLineCurve +
            ' to value ' +
            _oldLineCurve +
    ...
    prepareScales() {
        if (this.nest) {
            ...
            this.interpolating.y = linear.linear()
                .domain(oldYDomain)
                .range(oldYRange);
            this.interpolating.line = catmullRom.line()
        ...
        if (this.data[0][this.ordinalAccessor] instanceof Date) {
            ...
            const timeDiffInMilliseconds = time.timeMillisecond.count(minDate, maxDate);
            ...
            if (this.xAxis.unit) {
                ...
                this.x.domain([
                    new Date(time.timeMillisecond.offset(minDate, -genericTimePadding)),
                    new Date(time.timeMillisecond.offset(maxDate, genericTimePadding))
                ]);
            }
        }
        else {
    ...
    prepareLabelData() {
        if (this.nest) {
            ...
            this.nest.forEach(item => {
                ...
                // min
                const minIdx = minIndex.minIndex(values, d => d[this.valueAccessor]);
                const minItem = values[minIdx];
                // max
                const maxIdx = minIndex.maxIndex(values, d => d[this.valueAccessor]);
    ...
    innerScopeDataKeys() {
        ...
        chartAccessors.singleAccessors.forEach(accessor => {
            if (this[accessor] && min.min(this.data, d => d[this[accessor]]) !== undefined) {
    ...
    renderRootElements() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.lineChartEl)
            .select('.line-legend')
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.lineChartEl).select('.line-sub-title');
        ...
        if (this.interpolating) {
            ...
            this.updatingLabels
                ...
                const targetOpacity = d.exit
                    ? 0
                    : checkInteraction(d, checkLabelDisplayOnly(this.dataLabel.visible, this.dataLabel.displayOnly, d, this.displayOnlyLabelData, [this.ordinalAccessor, this.seriesAccessor]), this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
                        ? 0
                        : checkLabelDisplayOnly(this.dataLabel.visible, this.dataLabel.displayOnly, d, this.displayOnlyLabelData, [
                            this.ordinalAccessor,
                            this.seriesAccessor
            ...
            this.updatingLabels.attr('opacity', (d, i, n) => {
                const targetOpacity = checkInteraction(d, checkLabelDisplayOnly(this.dataLabel.visible, this.dataLabel.displayOnly, d, this.displayOnlyLabelData, [
                    this.ordinalAccessor,
                    this.seriesAccessor
                ]), this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
                    ? 0
    ...
    setLabelOpacity() {
        ...
        if (this.interpolating) {
            this.updatingLabels.each((d, i, n) => {
                ...
                if (!d.enter && !me.classed('entering') && !d.exit) {
                    me.attr('opacity', () => {
                        const targetOpacity = checkInteraction(d, checkLabelDisplayOnly(this.dataLabel.visible, this.dataLabel.displayOnly, d, this.displayOnlyLabelData, [this.ordinalAccessor, this.seriesAccessor]), this.hoverOpacity, this.hoverHighlight, this.clickHighlight, this.innerInteractionKeys) < 1
                            ? 0
                            : checkLabelDisplayOnly(this.dataLabel.visible, this.dataLabel.displayOnly, d, this.displayOnlyLabelData, [this.ordinalAccessor, this.seriesAccessor]);
                        const parentOpacity = +visaChartsUtils_umd.select(n[i].parentNode).attr('opacity');
    ...
    drawLegendElements() {
        ...
        const noSeriesAccessor = this.seriesAccessor === LineChartDefaultValues.seriesAccessor &&
            this.nest &&
            this.nest.length === 1 &&
    ...
    render() {
        ...
        // // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: '32f50d9a9b72780567bb703bbb9c73b6c723c40f', class: "o-layout" }, index.h("div", { key: 'f1ad34d4b7e6a6c9ede289425e8c8ce899d1a9fc', class: "o-layout--chart" }, index.h(this.topLevel, { key: '15f50ade0c0ee996bf32213981cfc82e269870da', class: "line-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: '9622da80983e75a0612025d0583214a8c93215fe', class: "visa-ui-text--instructions line-sub-title vcl-sub-title" }), index.h("div", { key: 'c57516115116ba6f26a812fd22b18b5fdd217ea7', class: "line-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: 'a4a78c6b7785038157dda2068ec96c0dce152c01', uniqueID: this.chartID, geomType: 'point', groupName: 'line', language: this.getLanguageString(), chartTag: 'line-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: '9d520b1e1dcad04654925cb6be0ebe69c95a863b', class: "visa-viz-d3-line-container" }), index.h("div", { key: '78ec230ea7823ff47f18f14d7acdc733cbf7043c', class: "line-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '9960d35b4c81f9228456867122f8371c3a29c2bc', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
        // reading properties
...
LineChart.style = LineChartStyle0;
