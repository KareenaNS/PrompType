...
DumbbellPlotDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
DumbbellPlotDefaultValues.localization = propDefaultValues.localization;
...
const DumbbellPlot = class {
    constructor(hostRef) {
        ...
        this.localization = DumbbellPlotDefaultValues.localization;
    ...
    prepareLabelData() {
        if (this.nest) {
            // min
            const minIdx = minIndex.minIndex(this.nest, d => min.min(d.values, v => v[this.valueAccessor]));
            const minArray = this.nest[minIdx].values;
            // max
            const maxIdx = minIndex.maxIndex(this.nest, d => max.max(d.values, v => v[this.valueAccessor]));
    ...
    renderRootElements() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.dumbbellPlotEl)
            ...
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.dumbbellPlotEl).select('.dumbbell-sub-title');
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: '3e861b45de729d51af481b46a06a00dbbfd0faa5', class: "o-layout" }, index.h("div", { key: 'e8fef1eddbdd83eea783def0cd9ad3d37ea0504f', class: "o-layout--chart" }, index.h(this.topLevel, { key: '81dbd711c7d18056f2f5c3dfc6d2675889082fb2', class: "dumbbell-main-title vcl-main-title", "data-testid": "main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: '909dc87b7a6ebf71e47036d1495486fb329ad297', class: "visa-ui-text--instructions dumbbell-sub-title vcl-sub-title", "data-testid": "sub-title" }), index.h("div", { key: '90d982c02e3afc15f8f66161f35b3a1d51e68e70', class: "dumbbell-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: 'df0cd6ac1c4729ef4b0deccb44183ab36b115678', uniqueID: this.chartID, language: this.getLanguageString(), geomType: 'dumbbell', chartTag: 'dumbbell-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: 'b86e71babcbc1e299de311126596c828f9ebf456', class: "visa-viz-d3-dumbbell-container" }), index.h("div", { key: '1c690d6115e7fc1ba103fdac620960d0d35ab62a', class: "dumbbell-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '28b5ef8e6e0d4c75833b46f4c411885ddb724383', uniqueID: this.chartID, unitTest: this.unitTest, language: this.getLanguageString(), isCompact: true, tableColumns: this.tableColumns, data: this.tableData, dataKeyNames: this.dataKeyNames, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton }))));
    }
    init() {
        // reading properties
...
DumbbellPlot.style = DumbbellPlotStyle0;

exports.dumbbell_plot = DumbbellPlot;

//# sourceMappingURL=dumbbell-plot.cjs.entry.js.map