...
const pow = require('./pow-645d5ba2.js');
...
ScatterPlotDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
ScatterPlotDefaultValues.localization = propDefaultValues.localization;
...
const ScatterPlotStyle0 = scatterPlotCss;
...
const ScatterPlot = class {
    ...
    renderRootElements() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.scatterChartEl)
            ...
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.scatterChartEl).select('.scatter-sub-title');
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: 'a76a5ed99aaab7d1a1f27aa10cee44f8fe7652e5', class: "o-layout" }, index.h("div", { key: 'ebf3bdfceeb58a916fcc2b10ad08ab27f2f3370d', class: "o-layout--chart" }, index.h(this.topLevel, { key: '11bb95a9ea035d9a7b740deba9aeacb94adff716', class: "scatter-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: 'b71dc286891fcb79746ce98839a0a08a83b12771', class: "visa-ui-text--instructions scatter-sub-title vcl-sub-title" }), index.h("div", { key: 'c2012b947125f56ed2e38bfea3baf16c2b34bd4f', class: "scatter-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: '2e3dd46c20619c6e17fcfbfc81b9693572bbc95d', uniqueID: this.chartID, geomType: 'point', groupName: 'scatter group', language: this.getLanguageString(), chartTag: 'scatter-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: 'da06db013823f5e0f98bac5549b0a795b99bcd04', class: "visa-viz-d3-scatter-container" }), index.h("div", { key: 'daf70506d1c6b612361fa459505d5e5b9e284b05', class: "scatter-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '376b0db12184db8f3061547c53e846d65b6a37b4', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, data: this.tableData, dataKeyNames: this.dataKeyNames, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
...
ScatterPlot.style = ScatterPlotStyle0;
