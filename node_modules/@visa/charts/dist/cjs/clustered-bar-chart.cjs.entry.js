...
ClusteredBarChartDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
ClusteredBarChartDefaultValues.localization = propDefaultValues.localization;
...
const ClusteredBarChart = class {
    constructor(hostRef) {
        ...
        this.localization = ClusteredBarChartDefaultValues.localization;
    ...
    renderRootElements() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.clusteredBarChartEl)
            ...
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.clusteredBarChartEl).select('.clustered-bar-sub-title');
    ...
    enterGeometries() {
        ...
        this.enter
            ...
            : this[valueAxis](d[this.valueAccessor]) - this[valueAxis](0)) || 0.000001 // avoiding getBBox dimension and coordinates issues
        )
            ...
            const geometryIsUpdating = checkAttributeTransitions(visaChartsUtils_umd.select(n[i]), [
                ...
                },
                {
                    ...
                    newValue: Math.abs(this.layout === 'vertical'
                        ? this[valueAxis](0) - this[valueAxis](d[this.valueAccessor])
                        : this[valueAxis](d[this.valueAccessor]) - this[valueAxis](0)) || 0.000001
                }
            ]);
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: '655d50cd007ed19689c72c54a65ec370f2616534', class: `o-layout is--${this.layout} ${theme}` }, index.h("div", { key: '6368d0c93419b787be534de0ed228c7b951edbfd', class: "o-layout--chart" }, index.h(this.topLevel, { key: '219b3779486b8231884f877b01e2770f68b89419', class: "clustered-bar-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: '80f6249bd25e54ff49204974b0fdb9a30aad0131', class: "visa-ui-text--instructions clustered-bar-sub-title vcl-sub-title" }), index.h("div", { key: 'bc922958dbb7f8cca02b27bf455735fbd9a2c462', class: "clustered-bar-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: '8d5e59373c9fc9368b1ff2b06005fb40dcd0c1f3', uniqueID: this.chartID, geomType: 'bar', groupName: 'cluster', language: this.getLanguageString(), chartTag: 'clustered-bar-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation // on bar this requires checking for groupAccessor
            : true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: 'e55b4ad8776710ba2c7571b85c39104fd354dcc7', class: "visa-viz-d3-clustered-bar-container" }), index.h("div", { key: 'bdf63720f6dc6c32db649bc8349c2730b43989b1', class: "clustered-bar-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: '98178b70d0da1ff4f49948513dc7548dd081b5f4', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
        // reading properties
...
ClusteredBarChart.style = ClusteredBarChartStyle0;

exports.clustered_bar_chart = ClusteredBarChart;

//# sourceMappingURL=clustered-bar-chart.cjs.entry.js.map