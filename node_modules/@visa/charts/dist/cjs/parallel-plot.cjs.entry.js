...
ParallelPlotDefaultValues.subTitle = propDefaultValues.subTitle.text;
...
ParallelPlotDefaultValues.localization = propDefaultValues.localization;
...
ParallelPlotDefaultValues.lineCurve = propDefaultValues.lineCurve;
...
const ParallelPlotStyle0 = parallelPlotCss;
...
const ParallelPlot = class {
    constructor(hostRef) {
        ...
        this.localization = ParallelPlotDefaultValues.localization;
        ...
        this.lineCurve = ParallelPlotDefaultValues.lineCurve;
    ...
    renderChartRootElemets() {
        ...
        this.legendG = visaChartsUtils_umd.select(this.parallelChartEl)
            ...
            .append('svg');
        this.subTitleG = visaChartsUtils_umd.select(this.parallelChartEl).select('.parallel-sub-title');
    ...
    setYAxisAccessibility() {
        const axisLabelX = this.xAxis.label || this.xAxis.label === ''
            ? this.xAxis.label
            : this.dataKeyNames && this.dataKeyNames[this.ordinalAccessor]
                ? this.dataKeyNames[this.ordinalAccessor]
                : this.xAxis.label;
    ...
    drawLegendElements() {
        ...
        const noSeriesAccessor = this.seriesAccessor === ParallelPlotDefaultValues.seriesAccessor &&
            this.nest &&
            this.nest.length === 1 &&
    ...
    render() {
        ...
        // // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (index.h("div", { key: '21f04fc5663d29280f4f081a07e36e111f743b44', class: "o-layout" }, index.h("div", { key: 'd6de1ee8a95bb68d26ba6fd1990dac1f54467ed7', class: "o-layout--chart" }, index.h(this.topLevel, { key: '679e3d1ca83f25db78510e9da6a1debb93abc105', class: "parallel-main-title vcl-main-title" }, this.mainTitle), index.h(this.bottomLevel, { key: 'bdf40ba23e9bdcb6257fc745726818a6ba51a295', class: "visa-ui-text--instructions parallel-sub-title vcl-sub-title" }), index.h("div", { key: '16923267e987a955c7f9eb5e6cf17dfedb156698', class: "parallel-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), index.h("keyboard-instructions", { key: 'a57d84c4abafcd22d8965922ef1ca629e69d225f', uniqueID: this.chartID, geomType: 'point', groupName: 'line', language: this.getLanguageString(), chartTag: 'parallel-plot', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), index.h("div", { key: '092fb1709f6af03a0058a83435aead61443eaa81', class: "visa-viz-d3-parallel-container" }), index.h("div", { key: '6ed5a6d56c8a420e92117146a585480411dfd8c2', class: "parallel-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), index.h("data-table", { key: 'ea329e3d995e5512835a12533afe55bd262dfc00', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
        // reading properties
...
ParallelPlot.style = ParallelPlotStyle0;

exports.parallel_plot = ParallelPlot;

//# sourceMappingURL=parallel-plot.cjs.entry.js.map