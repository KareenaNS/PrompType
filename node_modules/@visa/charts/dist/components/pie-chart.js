...
import { w as withPath, c as constant, a as array } from './p-fa69d97e.js';
import { h as halfPi, e as epsilon, t as tau, c as cos, s as sin, m as min, a as abs, b as atan2, p as pi, d as sqrt, f as max, g as asin, i as acos } from './p-c79b22e7.js';
...
const PieChart$1 = /*@__PURE__*/ proxyCustomElement(class PieChart extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (h("div", { key: 'fcc4118dfc21a7684f617e29283e58bab9fa9cf6', class: "o-layout is--vertical" }, h("div", { key: 'a0c58f57073887350712e27b38fb1387f3a9477d', class: "o-layout--chart" }, h(this.topLevel, { key: '229ea92633c6f866a7d56352f3fba8ee8821022c', class: "pie-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { key: '341897471fd98e1b98f1d8060ab2f6132d529cce', class: "visa-ui-text--instructions pie-sub-title vcl-sub-title" }), h("keyboard-instructions", { key: 'ea26f4c106b308fafbec8edda4da13ba536d9f62', uniqueID: this.chartID, geomType: 'slice', groupName: 'pie', language: this.getLanguageString(), chartTag: 'pie-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: false, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), h("div", { key: '75adca88ca2554f58fe644756251568c8eb4fa7a', class: "visa-viz-d3-pie-container" }), h("div", { key: '688600464cbf44a91ccde24c545f0f59cd25f1f0', class: "pie-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { key: '924be95af58ad22bee5275aeeda295bd341b22ee', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
    ...
    static get style() { return PieChartStyle0; }
}, [0, "pie-chart", {
        "localization": [1040],
