...
import { w as withPath, s as slice, c as constant } from './p-fa69d97e.js';
import { b as bumpX, a as bumpY } from './p-50f1a99e.js';
import { x, y } from './p-4f683f50.js';
...
// getScopedData,
checkHovered, initTooltipStyle, overrideTitleTooltip, scopeDataKeys, chartAccessors, sankey, sankeyCenter, sankeyJustify, sankeyLeft, sankeyLinkHorizontal, sankeyLinkVertical, sankeyRight, prepareRenderChange, visaColors, validateAccessibilityProps, validateLocalizationProps, setSubTitle } = Utils;
const AlluvialDiagram$1 = /*@__PURE__*/ proxyCustomElement(class AlluvialDiagram extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        h("div", { key: '239c56c8813ca9ffefb27d79889feb960f65ff68' }, h("div", { key: 'bfab71f0780570d3bee705f2d1b093d5a875fc66', class: "o-layout" }, h("div", { key: 'cb27635d243133f9b1317267d99bce5e27e0f602', class: "o-layout--chart" }, h(this.topLevel, { key: 'fa079bd089cf7c9301e92e4c4d7f76a6c366a80a', class: "alluvial-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { key: '47a02cb194c81d3af40fc4bd96b331bef78e94bb', class: "visa-ui-text--instructions alluvial-sub-title vcl-sub-title" }), h("keyboard-instructions", { key: '4e1228172a9f711a998893030dadd178c6147aa0', uniqueID: this.chartID, geomType: 'node', groupName: 'node collection', language: this.getLanguageString(), chartTag: 'alluvial-diagram', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: this.innerLinkFillMode === 'source' || this.innerLinkFillMode === 'target', disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), h("div", { key: 'd7c323ed2c41ca0084e4bde0a6c6236265962d2e', class: "visa-viz-d3-alluvial-container" }), h("div", { key: '2646ae41d976cc731b21018bfa04eaf7d3ae9f36', class: "alluvial-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { key: '3b94a8ba0b713d508aeed3c208a15b29f3b2c39e', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, secondaryData: this.secondaryTableData, secondaryTableColumns: this.secondaryTableColumns, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest })))));
    }
    init() {
        // reading properties
    ...
    static get style() { return AlluvialDiagramStyle0; }
}, [0, "alluvial-diagram", {
...
//# sourceMappingURL=alluvial-diagram.js.map