import { p as proxyCustomElement, H, c as createEvent, h } from './p-0e4cd689.js';
import { p as point } from './p-2c218f53.js';
import { l as linear, n as nest } from './p-cc952e89.js';
import { t as timeMillisecond, a as timeSecond, b as timeMinute, s as scaleTime } from './p-f62c64b9.js';
import { U as Utils } from './p-8635284c.js';
import { v as v4 } from './p-69c1c453.js';
import { s as select, e as event, d as defineCustomElement$3 } from './p-28fa1b23.js';
import { d as defineCustomElement$2 } from './p-894fcd4e.js';
import { t as timeHour, a as timeDay, s as sunday, b as timeMonth, c as timeYear } from './p-09f6650c.js';
import { c as curveLinear, a as curveCatmullRom, l as line } from './p-67f05ac6.js';
import { m as min } from './p-f9c89fe4.js';
import { m as max } from './p-e1d72334.js';
import { m as minIndex, a as maxIndex } from './p-848274b2.js';
import { c as circleIn } from './p-3f5e41ff.js';
...
const LineChart$1 = /*@__PURE__*/ proxyCustomElement(class LineChart extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    render() {
        ...
        // // be moved into componentWillUpdate (if the Stencil bug is fixed)
        return (h("div", { key: '32f50d9a9b72780567bb703bbb9c73b6c723c40f', class: "o-layout" }, h("div", { key: 'f1ad34d4b7e6a6c9ede289425e8c8ce899d1a9fc', class: "o-layout--chart" }, h(this.topLevel, { key: '15f50ade0c0ee996bf32213981cfc82e269870da', class: "line-main-title vcl-main-title" }, this.mainTitle), h(this.bottomLevel, { key: '9622da80983e75a0612025d0583214a8c93215fe', class: "visa-ui-text--instructions line-sub-title vcl-sub-title" }), h("div", { key: 'c57516115116ba6f26a812fd22b18b5fdd217ea7', class: "line-legend vcl-legend", style: { display: this.legend.visible ? 'block' : 'none' } }), h("keyboard-instructions", { key: 'a4a78c6b7785038157dda2068ec96c0dce152c01', uniqueID: this.chartID, geomType: 'point', groupName: 'line', language: this.getLanguageString(), chartTag: 'line-chart', width: this.width - (this.margin ? this.margin.right || 0 : 0), isInteractive: this.accessibility.elementsAreInterface, hasCousinNavigation: true, disabled: this.suppressEvents &&
                this.accessibility.elementsAreInterface === false &&
                this.accessibility.keyboardNavConfig &&
                this.accessibility.keyboardNavConfig.disabled }), h("div", { key: '9d520b1e1dcad04654925cb6be0ebe69c95a863b', class: "visa-viz-d3-line-container" }), h("div", { key: '78ec230ea7823ff47f18f14d7acdc733cbf7043c', class: "line-tooltip vcl-tooltip", style: { display: this.showTooltip ? 'block' : 'none' } }), h("data-table", { key: '9960d35b4c81f9228456867122f8371c3a29c2bc', uniqueID: this.chartID, isCompact: true, language: this.getLanguageString(), tableColumns: this.tableColumns, dataKeyNames: this.dataKeyNames, data: this.tableData, padding: this.padding, margin: this.margin, hideDataTable: this.accessibility.hideDataTableButton, unitTest: this.unitTest }))));
    }
    init() {
        // reading properties
    ...
    static get style() { return LineChartStyle0; }
}, [0, "line-chart", {
        "localization": [1040],
